...
class Bank{
    ...
    public void createAccounts(int AccNo, String AccHolderName, int AccBalance, int PIN){
    ...
    public void authenticate(int AccNo, int PIN) throws InvalidAccountNumberException, IncorrectPINException {
        Account account = findAccount(AccNo);
        if(account!=null){
...
public class BankingSystem{
    public static void main(String args[]){
        ...
        //creating account
        bank.createAccounts(23346, "Sujal", 20000, 1060);
        bank.createAccounts(23419, "Kumar", 30000, 1061);
